...
2. **`review/integration/01_android_hal.md` 설계 재검토**
...
**미결 사항 (다음 작업)**:
1. `01_android_hal.md`에 `setWiredDeviceConnectionState` 관련 권고(Android 12+는 AIDL 경로 우선) 반영
...
- `review/integration/01_android_hal.md` — 설계 검토 전문
